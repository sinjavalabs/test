...
<html>
    ...
    <body>
        ...
        <div id="show-worker" class="content scaffold-show" role="main">
            ...
            <f:display bean="worker" />
            <g:form resource="${this.worker}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.worker}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
